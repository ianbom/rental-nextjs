        ...
        <>
            <section className="relative w-full py-12 md:py-24 lg:py-32 xl:py-48 overflow-hidden">
                <video
                    ...
                    src="/CINEMATIC CAR VIDEO _ Toyota GT86 - BRZ - FRS _ Broll.mp4"
                    autoPlay
                    loop
                    muted
                />
                ...
                <div className="relative z-10 flex items-center justify-center w-full h-full">
                    <div className="text-white text-center">
                        <h1 className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold">Discover the Ultimate Freedom of Travel</h1>
                        <p className="mt-4 md:mt-6 lg:mt-8 xl:mt-10 text-lg md:text-xl lg:text-2xl xl:text-3xl">
                            With our top-quality vehicle rentals, your journey is our priority.
                        </p>
                        <Link
